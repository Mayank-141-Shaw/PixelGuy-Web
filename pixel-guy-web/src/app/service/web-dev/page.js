...
import softImg1 from "../../../assets/soft-1.jpg";
import softImg2 from "../../../assets/soft-2.png";
import softImg3 from "../../../assets/soft-3.png";
    ...
    <div>
      <section
        ...
        style={{
          ...
          backgroundImage: `url(${webImg.src})`,
      ...
      <section className="bg-transparent p-8 md:p-16 flex justify-center items-center">
        <div className="w-full md:w-[70%]">
          <p className="text-white text-[7vw] md:text-[5vw] font-bold text-shadow">
            Building the Software Solutions That Power Your Success
          </p>
          <p className="text-white text-[4vw] md:text-[2vw] font-semibold mt-4">
            We bring your software vision to life, crafting innovative and
            reliable solutions that drive results. Our team of skilled
            developers leverages their expertise in cutting-edge technologies to
            create custom software that seamlessly integrates with your existing
            systems and empowers your business to thrive.
          </p>
        </div>
      </section>
      ...
      <section className="grid w-full grid-cols-1 md:grid-cols-3 justify-between gap-4 md:gap-16 p-16 mt-16 mb-16 overflow-hidden">
        ...
        >
          <div className="relative h-full flex flex-col justify-between">
            <Image src={softImg2} className="h-full object-cover rounded-lg" />
          </div>
        </motion.div>
        ...
        >
          <div className="relative h-full flex flex-col justify-between">
            <Image src={softImg3} className="h-full object-cover rounded-lg" />
          </div>
        </motion.div>
      </section>
      ...
      <section className="p-16 flex flex-col md:flex-row gap-8 items-center bg-yellow-500 border-b-4 border-yellow-700">
        <span className="text-[5vw] md:text-2xl text-center md:text-start p-0 m-0 font-semibold">
          For availing software development services{" "}
        </span>
        <Link
