...
import mobImg1 from "../../../assets/mobi-dev-1.jpg";
import mobImg2 from "../../../assets/mobi-dev-2.png";
import mobImg3 from "../../../assets/mobi-dev-3.png";
    ...
    <div>
      ...
      <section className="bg-transparent p-8 md:p-16 flex justify-center items-center">
        <div className="w-full md:w-[70%]">
          <p className="text-white text-[7vw] md:text-[5vw] font-bold text-shadow">
            Elevate Your Mobile Vision: Expert Mobile App Development Services
          </p>
          <p className="text-white text-[4vw] md:text-[2vw] font-semibold mt-4">
            We bridge the gap between your mobile app idea and its success. Our
            skilled developers leverage the latest technologies and agile
            methodologies to create intuitive and user-centric mobile
            applications for any platform. From concept ideation to post-launch
            support, we collaborate with you throughout the entire development
            process to ensure your app delivers a seamless and unforgettable
            user experience.
          </p>
        </div>
      </section>
      ...
      <section className="p-16 flex flex-col md:flex-row gap-8 items-center bg-yellow-500 border-b-4 border-yellow-700">
        <span className="text-[5vw] md:text-2xl text-center md:text-start p-0 m-0 font-semibold">
          For availing app development services{" "}
        </span>
        <Link
