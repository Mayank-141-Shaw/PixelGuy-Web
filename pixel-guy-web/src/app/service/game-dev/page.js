      ...
      <section className="grid w-full grid-cols-1 md:grid-cols-3 justify-between gap-4 md:gap-16 p-16 mt-16 mb-16 overflow-hidden">
        ...
        >
          <div className="relative flex flex-col justify-between aspect-square">
            <Image src={gameImg1} className="h-full object-cover rounded-lg" />
          </div>
        </motion.div>
        ...
        >
          <div className="relative h-full flex flex-col justify-between">
            <Image src={gameImg2} className="h-full object-cover rounded-lg" />
          </div>
        </motion.div>
        ...
        >
          <div className="relative h-full flex flex-col justify-between">
            <Image src={gameImg3} className="h-full object-cover rounded-lg" />
          </div>
        </motion.div>
      </section>
